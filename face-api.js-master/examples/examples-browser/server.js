...
app.get('/webcam_face_expression_recognition', (req, res) => res.sendFile(path.join(viewsDir, 'newWebcamFaceExpressionRecognition.html')))
app.get('/new_webcam_face_expression_recognition', (req, res) => res.sendFile(path.join(viewsDir, 'newWebcamFaceExpressionRecognition.html')))
